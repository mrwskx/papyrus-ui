...
Claude assists with building and maintaining Papyrus UI components, tests, and Storybook docs; triaging and working GitHub issues; and following the skills and conventions below to keep changes consistent with the codebase's standards and domain model.
